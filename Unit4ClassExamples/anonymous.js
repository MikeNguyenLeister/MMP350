...
(function(msg){
	console.log(msg);
})("It's me!"); // notice that we send an argument into the function, that the function is encapsulated insdie (), and then we send a string wrapped in "" inside the () to send that argument to the function. And wen end with a ;. 
